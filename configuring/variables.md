...
| col.group\_border          | inactive (out of focus) group border color                                                                                       | gradient | 0x66777700 |
...
| hide\_cursor\_on\_touch        | Hides the cursor when the last input was a touch input until a mouse input is done.                                                                                                                                                                                    | bool | true     |
